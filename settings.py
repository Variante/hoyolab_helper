...
class _Config:
    ...
    USER_AGENT = 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) ' \
    ...
    HSR_REWARD_URL = 'https://sg-public-api.mihoyo.com/event/luna/os/home?lang={}&act_id={}'.format(LANG, HSR_ACT_ID)
    HSR_INFO_URL = 'https://sg-public-api.hoyolab.com/event/luna/os/info?lang={}&act_id={}'.format(LANG, HSR_ACT_ID)
    HSR_SIGN_URL = 'https://sg-public-api.hoyolab.com/event/luna/os/sign?lang={}'.format(LANG)
    # weibo
    ...
    WB_USER_AGENT = 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E150'
